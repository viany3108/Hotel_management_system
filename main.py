...
class Hotel:
    def __init__(self, root):
        ...
        # display message
        self.label = Label(top, font=('arial black', 60, 'bold'), text="WELCOME TO HOTEL VIVERA", fg="#15d3ba", anchor="center")
        self.label.grid(row=0, column=3)

        # create check in button
        self.check_in_button = Button(bottom, text="CHECK IN", font=('', 20), bg="#15d3ba", relief=RIDGE, height=3,
                                      width=50,
        ...
        self.check_out_button = Button(bottom, text="CHECK OUT", font=('', 20), bg="#15d3ba", relief=RIDGE, height=3,
        ...
        self.room_info_button = Button(bottom, text="ROOM INFORMATION ", font=('', 20), bg="#15d3ba", relief=RIDGE,
                                       height=3,
                                       width=50, fg="black", anchor="center",
        ...
        self.get_info_button = Button(bottom, text="INFORMATION OF ALL GUEST", font=('', 20), bg="#15d3ba",
                                      relief=RIDGE,
                                      height=3, width=50, fg="black", anchor="center",
        ...
        self.exit_button = Button(bottom, text="EXIT", font=('', 20), bg="#15d3ba", relief=RIDGE, height=3, width=50,
                                  fg="black",
